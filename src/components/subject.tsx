...
<div className='flex flex-col items-start'>
        ...
        <div className='flex flex-row items-center justify-between w-full'>
            ...
            <button
      onClick={toggle}
      className={`w-[48px] h-[27px] flex items-center bg-[#004C97] rounded-full p-1 cursor-pointer transition-colors duration-300 ${
        isOn ? 'bg-[#fff]' : 'bg-[#004C97]'
      }`}
    >
      <div
        className={`w-[23px] h-[23px] rounded-full shadow-md transform transition-transform duration-300 ${
          isOn ? 'translate-x-6 bg-[#004C97]' : 'translate-x-[-1px] bg-white'
        }`}
      />
    </button>
        </div> 
